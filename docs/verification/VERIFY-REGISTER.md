...
| VERIFY-013 | OPEN | Exact Guild Wars 2 Trading Post fee contract for a sale: 5% listing fee plus 10% exchange fee is the proposed M9 policy, but exact integer-copper rounding and any minimum fee must be confirmed before modeled profit is authoritative. | M9 product decision recorded 2026-08-31; no authoritative fee-rounding source recorded yet. | TKT-M9-03 | 2026-08-31 | — |
