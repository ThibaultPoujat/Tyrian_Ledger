...
| VERIFY-014 | IN PROGRESS | M10 scheduled capture and static deployment evidence is pending: record trusted workflow evidence for the 15-minute capture, configured request/concurrency/burst limits, selector validation and `develop` fallback, static-artifact contents, and the pre-publication audit before the owner makes the repository or Pages site public. | TKT-M10-05 adds the source-level trusted workflow, fixture-based artifact assembly/audit, and documented evidence procedure on 2026-09-02. Actual push/scheduled run, Pages deployment, and candidate public-history-audit evidence remain pending until the owner approves the separate repository/Pages action. This is deployment evidence, not confirmation of external Guild Wars 2 API behaviour; batching, schema, rate-limit, retry, and fee facts remain under VERIFY-004, -005, -006, -010, -011, and -013. | TKT-M10-05 | 2026-09-01 | — |
