...
Tickets and prompts are grouped by milestone to keep agent context bounded and reduce navigation noise.

Each milestone directory contains:

- `tickets/` — authoritative ticket definitions;
- `prompts/` — lightweight execution prompts for Pi/Qwen.

A ticket may be completed across multiple fresh sessions. See `docs/workflow/ai-development-workflow.md` and `docs/workflow/agent-execution-rules.md`.
...
| M1 | Repository and development foundation | [TKT-M1-01](M1/tickets/TKT-M1-01.md), [TKT-M1-02](M1/tickets/TKT-M1-02.md), [TKT-M1-03](M1/tickets/TKT-M1-03.md), [TKT-M1-04](M1/tickets/TKT-M1-04.md) |
...
For any ticket, use the prompt with the same ticket code from the same milestone's `prompts/` directory.
