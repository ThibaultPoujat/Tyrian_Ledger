...
#129 TKT-M21-S01  self-healing CURRENT live state
 -> #130 TKT-M21-S02  Mes Signaux UX spike
 -> #131 TKT-M21-S03  Mes Signaux MVP + primary navigation
 ...
 -> #94  TKT-M21-03   guided crafting paths + Artisanat UI
...
- after TKT-M21-S03 / #131: first usable attention-first French `Mes Signaux` MVP;
- after TKT-M21-S05 / #133: stable executable Active/Passive plans with responsive reversible local shadow/reconciliation;
- after TKT-M21-03 / #94: crafting is a first-class guided profit engine and `Artisanat` workspace;
...
M12-M18 local/account/history foundation
 ...
 -> Mes Signaux transition (S01-S05)
...
Existing GitHub milestone objects M12-M22 are retained. The M21 object is reused for the Mes Signaux transition plus remaining crafting work so renumbering is unnecessary. Repository docs define the explicit execution order above.
