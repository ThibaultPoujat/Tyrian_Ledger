...
## Agent context
Load `AGENTS.md`, `docs/context/permanent-context.md`, the VERIFY register, and one M3 ticket. Read finance-related specs and test guidance only when needed.

## Session rule
Separate calculator implementation, test expansion, and review when useful. Git commits are the hand-off.
