...
- Show operation count, realized profit since first recorded use, average modeled/realized metrics where justified, and completion rate where defined.
- Clearly show the historical coverage period.
...
- Create/use a dedicated branch named `ticket/<TKT-M6-03>-<short-kebab-title>`.
- Every commit for this ticket MUST start with `[TKT-M6-03]`.
- Before declaring the ticket complete, push the branch and create a GitHub pull request titled `[TKT-M6-03] Short title`.
