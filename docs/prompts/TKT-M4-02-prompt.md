...
- Show acquisition/exit assumptions, fees, modeled profit, ROI, capital, order-book impact, liquidity, and data age.
- Provide a human-readable calculation breakdown.
- Clearly distinguish scenario values from actual outcomes.
...
- Create/use a dedicated branch named `ticket/<TKT-M4-02>-<short-kebab-title>`.
- Every commit for this ticket MUST start with `[TKT-M4-02]`.
- Before declaring the ticket complete, push the branch and create a GitHub pull request titled `[TKT-M4-02] Short title`.
