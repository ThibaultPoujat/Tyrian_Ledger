...
- Create/use a dedicated branch named `ticket/<TKT-M5-01>-<short-kebab-title>`.
- Every commit for this ticket MUST start with `[TKT-M5-01]`.
- Before declaring the ticket complete, push the branch and create a GitHub pull request titled `[TKT-M5-01] Short title`.
