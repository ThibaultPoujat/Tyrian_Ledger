...
- Changing preferences re-ranks or filters results deterministically.
...
- Create/use a dedicated branch named `ticket/<TKT-M4-03>-<short-kebab-title>`.
- Every commit for this ticket MUST start with `[TKT-M4-03]`.
- Before declaring the ticket complete, push the branch and create a GitHub pull request titled `[TKT-M4-03] Short title`.
