...
- Document SQLite backup/restore at a user level.
- No data is silently uploaded.
...
- Create/use a dedicated branch named `ticket/<TKT-M6-04>-<short-kebab-title>`.
- Every commit for this ticket MUST start with `[TKT-M6-04]`.
- Before declaring the ticket complete, push the branch and create a GitHub pull request titled `[TKT-M6-04] Short title`.
